using TrustNotifyHelper.Services;
...
namespace TrustNotifyHelper
{
    public partial class Main : Form
    {
        ...
        private readonly string PackageName = "xyz.k4czp3r.trustnotify";
        private readonly string[] PermissionsToGrant = { "android.permission.WRITE_SECURE_SETTINGS"};
